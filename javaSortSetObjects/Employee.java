...
public class Employee implements Comparable<Employee>
{
	...
	{ 
		return this.employeeName.compareTo(e1.employeeName); 
	}


	/*
	 * @Override public int compareTo(Employee e1) { if(this.employeeId ==
	 * e1.employeeId) { return 0; } else if(this.employeeId < e1.employeeId) {
